...
using ExceptionCallback        = std::function<void(const Exception& e, char *data)>;
using ProgressCallback         = std::function<void(const Progress& progress)>;
using SelectCallback           = std::function<void(const Block& block, char *data)>;
...
public:
    ...
    inline Query& OnData(SelectCallback cb) {
	 ...
	 inline Query& SetOnData(SelectCallback cb, char *data) {
        select_cb_ = cb;
		datas = data;
        return *this;
    }
    ...
    inline Query& OnException(ExceptionCallback cb, char *data) {
        exception_cb_ = cb;
		datas = data;
        return *this;
    }
